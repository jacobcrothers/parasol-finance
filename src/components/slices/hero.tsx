      ...
      <div className="col-span-12 lg:col-span-6 text-center lg:text-left lg:flex lg:items-center">
        <div className="pb-3">
          <a href="https://solana.com/" target="_blank"
            className="inline-flex items-center text-white bg-pink-600 bg-opacity-0 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200" rel="noreferrer">
            <svg className="h-7" viewBox="0 0 96 86" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
