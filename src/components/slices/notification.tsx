...
const Notification: React.FC<NotificationProps> = ({title, source, color}) => {
  return <div aria-live="assertive" className="fixed inset-0 z-30 flex px-4 py-6 pointer-events-none sm:p-6 mt-16">
    <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
      ...
      <div id="hideMe" className={`max-w-sm w-full rounded-xl pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden ${color}`}>
        <div className="p-4">
          <div className="flex items-start">
            <div className="flex-shrink-0">
              <svg className="h-6 w-6 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
