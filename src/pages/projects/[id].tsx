          ...
          <div className="prose markdown prose-lg prose-invert col-span-6">
            <div className="flex items-center gap-x-6">
              <img
                ...
                src="https://storage.googleapis.com/polkastarter-production-assets/aovnyvd72hvhc5l8ab2e9404jq0h"
                alt=""
              />
              <div>
              ...
              <div className="relative bg-[#231f38] bg-opacity-50 shadow-half-strong border border-gray-800 rounded-lg">
                <div className={"relative px-6 pt-6 pb-6"}>
                  ...
                  <div className="prose prose-lg prose-invert">
                    <p>
                      The allowlist for Orbitau is now available and you can
                      apply for it below.
                    </p>
                    <p>
                      Note that you need to have at least 250 POLS Power to
                      qualify for this allowlist. Learn more.
                    </p>
                  </div>
